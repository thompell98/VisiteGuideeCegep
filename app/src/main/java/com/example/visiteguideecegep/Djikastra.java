...
public class Djikastra {
    ...
    private void creerLesIntersections(){
        lesIntersections[0][0] = new Intersection(70, 695, new int[]{1});
        lesIntersections[0][1] = new Intersection( 130, 695, new int[]{0, 2, 3});
        lesIntersections[0][2] = new Intersection( 130, 720, new int[]{1});
        lesIntersections[0][3] = new Intersection( 180, 695, new int[]{1, 4});
        lesIntersections[0][4] = new Intersection( 350, 695, new int[]{3, 5});
        lesIntersections[0][5] = new Intersection( 420, 695, new int[]{4, 6, 7});
        lesIntersections[0][6] = new Intersection( 420, 630, new int[]{5});
        lesIntersections[0][7] = new Intersection( 562, 695, new int[]{5, 8, 10});
        lesIntersections[0][8] = new Intersection( 800, 695, new int[]{7, 9});
        lesIntersections[0][9] = new Intersection( 800, 645, new int[]{8});
        lesIntersections[0][10] = new Intersection( 562, 600, new int[]{7, 11});
        lesIntersections[0][11] = new Intersection( 562, 510, new int[]{10, 12});
        lesIntersections[0][12] = new Intersection( 562, 420, new int[]{11, 13});
        lesIntersections[0][13] = new Intersection( 562, 280, new int[]{12, 14, 15, 16});
        lesIntersections[0][14] = new Intersection( 562, 240, new int[]{13});
        ...
        lesIntersections[1][9] = new Intersection( 880, 695, new int[]{8});
        lesIntersections[1][10] = new Intersection( 800, 630, new int[]{8, 18});
        lesIntersections[1][11] = new Intersection( 575, 510, new int[]{12, 18});
        lesIntersections[1][12] = new Intersection( 575, 300, new int[]{11, 13, 15});
        lesIntersections[1][13] = new Intersection( 630, 290, new int[]{12, 14});
        lesIntersections[1][14] = new Intersection( 720, 265, new int[]{13});
        lesIntersections[1][15] = new Intersection( 575, 250, new int[]{12, 16});
        ...
        lesIntersections[2][3] = new Intersection( 160, 600, new int[]{1, 4});
        lesIntersections[2][4] = new Intersection( 160, 490, new int[]{3, 5});
        lesIntersections[2][5] = new Intersection( 160, 370, new int[]{4, 6});
        lesIntersections[2][6] = new Intersection( 160, 260, new int[]{5, 7});
        lesIntersections[2][7] = new Intersection( 160, 150, new int[]{6});
        lesIntersections[2][8] = new Intersection( 335, 695, new int[]{1, 9});
        lesIntersections[2][9] = new Intersection( 480, 695, new int[]{8, 10, 11});
        lesIntersections[2][10] = new Intersection( 480, 630, new int[]{9});
        lesIntersections[2][11] = new Intersection( 580, 695, new int[]{9, 12});
        lesIntersections[2][12] = new Intersection( 705, 695, new int[]{11, 13, 17});
        lesIntersections[2][13] = new Intersection( 790, 695, new int[]{12, 14, 16});
        lesIntersections[2][14] = new Intersection( 880, 695, new int[]{13, 15});
        lesIntersections[2][15] = new Intersection( 970, 695, new int[]{14});
        lesIntersections[2][16] = new Intersection( 790, 630, new int[]{13});
        lesIntersections[2][17] = new Intersection( 705, 550, new int[]{12, 18});
        lesIntersections[2][18] = new Intersection( 705, 260, new int[]{17, 19, 20});
        lesIntersections[2][19] = new Intersection( 880, 200, new int[]{18});
        lesIntersections[2][20] = new Intersection( 580, 260, new int[]{18, 21});
        lesIntersections[2][21] = new Intersection( 580, 200, new int[]{20});
        lesIntersections[3][0] = new Intersection( 70, 660, new int[]{1});
        lesIntersections[3][1] = new Intersection( 165, 660, new int[]{0, 2, 3, 7});
        lesIntersections[3][2] = new Intersection( 165, 750, new int[]{1});
        lesIntersections[3][3] = new Intersection( 165, 560, new int[]{1, 4});
        lesIntersections[3][4] = new Intersection( 165, 470, new int[]{3, 5});
        lesIntersections[3][5] = new Intersection( 165, 370, new int[]{4, 6});
        lesIntersections[3][6] = new Intersection( 165, 280, new int[]{5});
        lesIntersections[3][7] = new Intersection( 300, 660, new int[]{1, 8});
        lesIntersections[3][8] = new Intersection( 380, 660, new int[]{7, 9});
        lesIntersections[3][9] = new Intersection( 480, 660, new int[]{8, 10, 11});
        lesIntersections[3][10] = new Intersection( 480, 595, new int[]{9});
        lesIntersections[3][11] = new Intersection( 560, 660, new int[]{9, 12});
        lesIntersections[3][12] = new Intersection( 640, 660, new int[]{11, 13});
        lesIntersections[3][13] = new Intersection( 720, 660, new int[]{12, 14});
        lesIntersections[3][14] = new Intersection( 790, 660, new int[]{13, 15, 16});
        lesIntersections[3][15] = new Intersection( 790, 595, new int[]{14});
        lesIntersections[3][16] = new Intersection( 880, 660, new int[]{14, 17});
        lesIntersections[3][17] = new Intersection( 935, 660, new int[]{16});
        lesIntersections[3][18] = new Intersection( 640, 170, new int[]{19});
        lesIntersections[3][19] = new Intersection( 880, 90, new int[]{18});
        lesIntersections[4][0] = new Intersection( 70, 660, new int[]{1});
        lesIntersections[4][1] = new Intersection( 155, 660, new int[]{0, 2, 3, 8});
        lesIntersections[4][2] = new Intersection( 155, 750, new int[]{1});
        lesIntersections[4][3] = new Intersection( 155, 580, new int[]{1, 4});
        lesIntersections[4][4] = new Intersection( 155, 425, new int[]{3, 5});
        lesIntersections[4][5] = new Intersection( 155, 380, new int[]{4, 6});
        lesIntersections[4][6] = new Intersection( 215, 380, new int[]{5, 7});
        lesIntersections[4][7] = new Intersection( 215, 300, new int[]{6});
        lesIntersections[4][8] = new Intersection( 310, 660, new int[]{1, 9});
        lesIntersections[4][9] = new Intersection( 410, 660, new int[]{8, 10});
        lesIntersections[4][10] = new Intersection( 480, 660, new int[]{9, 11, 12});
        lesIntersections[4][11] = new Intersection( 480, 600, new int[]{10});
        lesIntersections[4][12] = new Intersection( 560, 660, new int[]{10, 13});
        lesIntersections[4][13] = new Intersection( 650, 660, new int[]{12, 14});
        lesIntersections[4][14] = new Intersection( 730, 660, new int[]{13, 15});
        lesIntersections[4][15] = new Intersection( 790, 660, new int[]{14, 16, 17});
        lesIntersections[4][16] = new Intersection( 790, 600, new int[]{15});
        lesIntersections[4][17] = new Intersection( 870, 660, new int[]{15, 18});
        lesIntersections[4][18] = new Intersection( 960, 660, new int[]{17});
        lesIntersections[4][19] = new Intersection( 640, 170, new int[]{20});
        lesIntersections[4][20] = new Intersection( 880, 90, new int[]{19});
    }
